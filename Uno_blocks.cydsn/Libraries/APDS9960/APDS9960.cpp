...
#if DEBUG
            Serial1.print("FIFO Level: ");
            Serial1.println(fifo_level);
#endif
...
#if DEBUG
                Serial1.print("FIFO Dump: ");
                for ( i = 0; i < bytes_read; i++ ) {
                    Serial1.print(fifo_data[i]);
                    Serial1.print(" ");
                }
                Serial1.println();
#endif
...
#if DEBUG
                Serial1.print("Up Data: ");
                for ( i = 0; i < gesture_data_.total_gestures; i++ ) {
                    Serial1.print(gesture_data_.u_data[i]);
                    Serial1.print(" ");
                }
                Serial1.println();
#endif
...
#if DEBUG
                            //Serial1.println(gesture_motion_);
#endif
                        }
                    }
...
#if DEBUG
            Serial1.print(F("Finding last: "));
            Serial1.print(F("U:"));
            Serial1.print(gesture_data_.u_data[i]);
            Serial1.print(F(" D:"));
            Serial1.print(gesture_data_.d_data[i]);
            Serial1.print(F(" L:"));
            Serial1.print(gesture_data_.l_data[i]);
            Serial1.print(F(" R:"));
            Serial1.println(gesture_data_.r_data[i]);
#endif
            if( (gesture_data_.u_data[i] > GESTURE_THRESHOLD_OUT) &&
                (gesture_data_.d_data[i] > GESTURE_THRESHOLD_OUT) &&
                (gesture_data_.l_data[i] > GESTURE_THRESHOLD_OUT) &&
...
#if DEBUG
    Serial1.print(F("Last Values: "));
    Serial1.print(F("U:"));
    Serial1.print(u_last);
    Serial1.print(F(" D:"));
    Serial1.print(d_last);
    Serial1.print(F(" L:"));
    Serial1.print(l_last);
    Serial1.print(F(" R:"));
    Serial1.println(r_last);

    Serial1.print(F("Ratios: "));
    Serial1.print(F("UD Fi: "));
    Serial1.print(ud_ratio_first);
    Serial1.print(F(" UD La: "));
    Serial1.print(ud_ratio_last);
    Serial1.print(F(" LR Fi: "));
    Serial1.print(lr_ratio_first);
    Serial1.print(F(" LR La: "));
    Serial1.println(lr_ratio_last);
#endif
...
#if DEBUG
    Serial1.print("Deltas: ");
    Serial1.print("UD: ");
    Serial1.print(ud_delta);
    Serial1.print(" LR: ");
    Serial1.println(lr_delta);
#endif
...
#if DEBUG
    Serial1.print("Accumulations: ");
    Serial1.print("UD: ");
    Serial1.print(gesture_ud_delta_);
    Serial1.print(" LR: ");
    Serial1.println(gesture_lr_delta_);
#endif
...
#if DEBUG
    Serial1.print("UD_CT: ");
    Serial1.print(gesture_ud_count_);
    Serial1.print(" LR_CT: ");
    Serial1.print(gesture_lr_count_);
    Serial1.print(" NEAR_CT: ");
    Serial1.print(gesture_near_count_);
    Serial1.print(" FAR_CT: ");
    Serial1.println(gesture_far_count_);
    Serial1.println("----------");
#endif
...
bool SparkFun_APDS9960::wireReadDataByte(uint8_t reg, uint8_t &val)
{
    ...
    { /* wait for data to come back from the device */ }
    val = Wire.read();
